            ...
            <el-row>
              ...
              >
                <div class="pd_left_20">
                  ...
                  <div class="info_item">
                    <label class="label_item">用户入住：</label>
      ...
      <el-row class="baseView baseView4">
        ...
        <el-col :span="24" :xs="24" :sm="24" :md="12" :lg="12" style="float:right">
          <div class="gray_box baseView baseView5" style="height:240px">
            <div>
              <h2 class="item_title">入住信息</h2>
              <div class="item_form">
                <el-row>
                  <div class="info_item">
                    <label class="label_item">入住楼号：</label>
                    <span>{{ goodsData.buildingNumber }}</span>
                  </div>
                  <div class="info_item">
                    <label class="label_item">房间床位号：</label>
                    <span>{{ goodsData.bedNumber }}</span>
                  </div>
                  <div class="info_item">
                    <label class="label_item">入住时间：</label>
                    <span v-if="goodsData.consumptionTime">{{ $moment(goodsData.consumptionTime+'Z').utcOffset(offset).format('YYYY-MM-DD HH:mm:ss') }}</span>
                  </div>
                </el-row>
              </div>
