...
export default {
  ...
  methods: {
    ...
    _addData() {
      this.$router.push('/nursing_training/theory_course_mng/add_theory_course')
    },
    handleEdit(id) {
      this.$router.push({
        path: '/nursing_training/theory_course_mng/look_theory_course',
        query: {
          id: id
        }
      })
    ...
    _Scheduling(id) {
      this.$router.push({
        path: '/nursing_training/theory_course_mng/schedule_setting',
        query: {
          id: id
        }
      })
    ...
    updateData(id) {
      this.$router.push({
        path: '/nursing_training/theory_course_mng/update_theory_course',
        query: {
          id: id
        }
      })
