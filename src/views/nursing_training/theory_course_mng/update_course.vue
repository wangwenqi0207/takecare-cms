        ...
        <div>
          ...
          <div class="item_form">
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="授课机构" prop="description">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="授课地址" prop="code">
...
export default {
  ...
  methods: {
    cancel() {
      this.$router.push('/nursing_training/theory_course_mng/theory_course_list')
    },
    getImgIndex(index) {
      this.imgIndex = index
    },
