...
export default {
  ...
  methods: {
    ...
    _addData() {
      this.$router.push('/nursing_training/assessment_mng/add_assessment')
    },
    handleEdit(id) {
      this.$router.push({
        path: '/nursing_training/assessment_mng/look_assessment',
        query: {
          id: id
        }
      })
    ...
    _Scheduling(id) {
      this.$router.push({
        path: '/nursing_training/assessment_mng/schedule_setting',
        query: {
          id: id
        }
      })
    ...
    updateData(id) {
      this.$router.push({
        path: '/nursing_training/assessment_mng/update_assessment',
        query: {
          id: id
        }
      })
