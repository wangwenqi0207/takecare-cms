...
export default {
  ...
  data() {
    ...
    return {
      ...
      show: false,
      coverImgUrl: 'http://ecare-test.oss-cn-hangzhou.aliyuncs.com/nursing_training/test/sence_1569226778000.jpg',
      imgName: 'sence_1569226778000.jpg',
      // oss返回路径name
      onLineImgPath: '',
      // 基本信息表单
      baseForm: {
  ...
  methods: {
    ...
    cancle() {
      this.$confirm('取消后将不保存该视频信息，是否取消?', '提示', {
        ...
        const deleteData = [this.onLineImgPath]
