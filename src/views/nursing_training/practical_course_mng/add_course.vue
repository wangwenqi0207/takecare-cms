  ...
  <div id="scrollBox" class="ss" style="overflow:auto;height:100%">
    ...
    <el-form ref="baseForm" :model="baseForm" :rules="baseRules" label-width="100px" class="demo-ruleForm">
        ...
        <div>
          ...
          <div class="item_form">
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="考核机构" prop="description">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="考核地址" prop="code">
                  <el-input v-model="baseForm.code" />
                </el-form-item>
              </el-col>
            </el-row>
          </div>
      ...
      <div class="gray_box baseView baseView3">
        <div>
          <h2 class="item_title">考核描述</h2>
          <div class="item_form">
            <el-row>
              <el-form-item label="缩略图" style="margin-bottom:0">
                <el-col>
                  <div class="avatar-uploader">
                    <div class="el-upload el-upload--text listImgBox" @click="function(){show=true}">
                      <i v-if="!listImg" class="el-icon-plus avatar-uploader-icon" />
                      <img v-else :src="listImg" alt="" style="width:110px;height:100px">
                    </div>
                  </div>
                </el-col>
                <my-upload v-model="show" field="img" :width="220" :height="200" img-format="png" :size="size" @src-file-set="srcFileSet" @crop-success="cropSuccess" />
              </el-form-item>
            </el-row>
          </div>
          <div class="item_form">
            <div class="pic_group">
              <el-row>
                <el-form-item label="图片" style="margin-bottom:0" prop="picInfo">
                  <el-col><span>图片单张大小不超过3M，图片规格700*700</span></el-col>
                  <el-col style="position:relative;over-flow:hidden">
                    ...
                    <div v-for="(item,index) in productImages" :key="index" class="uploader-box-div" @click="getImgIndex(index)">
                      ...
                      <el-dialog :visible.sync="picturePreviewDialog">
          ...
          <div class="item_form">
            <el-row>
              <el-form-item label="图文详情" required>
                <div class="edit_container" style="width:60%">
                  <quill-editor
                    ref="myQuillEditor"
...
export default {
  ...
  methods: {
    cancel() {
      this.$router.push('/nursing_training/practical_course_mng/practical_course_list')
    },
    getImgIndex(index) {
      this.imgIndex = index
    },
