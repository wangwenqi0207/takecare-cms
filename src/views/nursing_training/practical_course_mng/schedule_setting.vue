...
export default {
  ...
  created() {
    if (this.$route.path === '/nursing_training/practical_course_mng/schedule_setting') {
      this.isNative = true
    } else {
      this.isNative = false
    }
  ...
  methods: {
    ...
    _addData() {
      ...
      // })
      this.$router.push({
        path: '/nursing_training/practical_course_mng/schedule_setting/schedule_add'
      })
    },
    handleEdit(id) {
      this.$router.push({
        path: '/nursing_training/practical_course_mng/schedule_setting/schedule_detail',
        query: {
          id: id
        }
      })
