          ...
          <div class="item_form">
            <el-row>
              <el-col :span="24" :xs="24" :sm="24" :md="12" :lg="12">
                <div class="pd_left_20">
                  <div class="info_item">
                    <label class="label_item">护理所属月份:</label>
                    <span v-if="goodsData.serviceDate">{{ $moment(goodsData.serviceDate).format('YYYY年MM月') }}</span>
                  </div>
                  <div class="info_item">
                    <label class="label_item">参保人姓名：</label>
                  ...
                  <div class="info_item">
                    <label class="label_item">身份证号:</label>
                    <span>{{ goodsData.customerIDCard }}</span>
                  </div>
                  <div class="info_item">
                    <label class="label_item">长护险状态:</label>
                    <span>{{ goodsData.insuranceStatus }}</span>
                  </div>
                  <div class="info_item">
