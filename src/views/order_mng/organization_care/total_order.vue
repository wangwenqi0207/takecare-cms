...
export default {
  ...
  mounted() {
    this.resourcePermission = permissionData('机构护理订单')
    this.offset = offset()
  },
  methods: {
        ...
        if (valid) {
          ...
          cancelOrder6002(obj).then(res => {
            if (res) {
              ...
              this.searchData()
              this.getAllOrder([{ 'key': 'Type', 'value': '2' }], 'first')
              this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '0' }], 'second')
              this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '1' }], 'third')
              this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '5' }], 'seven')
              this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '6' }], 'eight')
            } else {
              this.$message({
                type: 'warning',
                message: '取消失败!'
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          assignOrgToService6002(dataObj).then(res => {
            ...
            this.getAllOrder([{ 'key': 'Type', 'value': '2' }], 'first')
            this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '2' }], 'fourth')
            this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '1' }], 'third')
      ...
      this.$refs.formHLY.validate((valid) => {
        if (valid) {
          ...
          assignStaff6002(dataObj).then(res => {
            ...
            this.getAllOrder([{ 'key': 'Type', 'value': '2' }], 'first')
            this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '3' }], 'five')
            this.getAllOrder([{ 'key': 'Type', 'value': '2' }, { 'key': 'OrderStatus', 'value': '2' }], 'fourth')
