    ...
    >
                ...
                <div class="pd_left_20">
                  ...
                  <div v-show="isSale==2">
                    <div class="info_item">
                      ...
                      <span>￥20</span>/<span>天</span>
                    </div>
                    <div class="info_item">
                      <label class="label_item">开始时间：</label>
                      <span>2019-07-09</span>
                    </div>
                    <div class="info_item">
                      <label class="label_item">结束时间：</label>
                      <span>2019-09-08</span>
                    </div>
                    <div class="info_item">
                      <label class="label_item">租期：</label>
                      <span>60</span><span>天</span>
                    </div>
                  </div>
                  <!-- 出售信息 -->
      ...
      <el-row class="baseView baseView4">
        ...
        <el-col :span="24" :xs="24" :sm="24" :md="12" :lg="12" style="float:left">
          <div class="gray_box baseView baseView4" style="margin-right:20px;height:240px">
            <div>
              ...
              <div class="item_form1">
                <el-row>
                  ...
                  <div class="info_item">
                    ...
                    <span v-if="goodsData.staffCertificate==0">护理资格证</span>
                    ...
                    <!-- <span>{{ goodsData.staffCertificate }}</span> -->
                  </div>
                </el-row>
              </div>
            </div>
