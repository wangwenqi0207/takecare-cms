  ...
  <div id="userDetail" style="height:100%;">
    <div style="height: 100%;background: #fff;overflow:auto;min-width:1200px;">
            ...
            <!-- <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="社保状态" required>
                  <el-input style="width:100%;">代理人</el-input>
                </el-form-item>
              </el-col>
            </el-row> -->
            <el-row>
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="公安实名认证" prop="hasAuthentication">
                  <el-radio v-model="form.hasAuthentication" :label="true">通过</el-radio>
                  <el-radio v-model="form.hasAuthentication" :label="false">不通过</el-radio>
                </el-form-item>
              </el-col>
              <el-col :span="7">
                &nbsp;
      ...
      <el-row style="margin:20px;padding-left:50px;">
        <el-button size="medium" @click="onSubmit">取消</el-button>
...
import { appUserInfo } from '@/api/auth'
export default {
  components: {
