      ...
      children: [
        // 全部订单
        {
          ...
          children: [
            ...
            // 护理器材订单详情
            {
              path: 'care_equipment_order_detail',
              name: '护理器材订单详情',
